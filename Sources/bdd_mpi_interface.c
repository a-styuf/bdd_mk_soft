/**
******************************************************************************
* @file           : oai_mpi_inteface.c
* @version        : v1.0
* @brief          : библиотека для работы с протоколом МПИ, используемым в БДД
...
/**
  * @brief  фугкция для корректной записи 32-битных значений в регистры МПИ
  * @param  u32_val число для записи
  * @retval корректное значение для записи
  */
uint32_t mpi_int_u32_write(uint32_t u32_val)
{
	return 0;
}
