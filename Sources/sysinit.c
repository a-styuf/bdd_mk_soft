/**
  ...
  * @file           : sysinit.c
  * @version        : v1.0
  * @brief          : первичная инициализация МК для БДД-МК
...
void System_Init() {
  *((uint32_t*)0xE000ED08) = (uint32_t)&__Vectors;
  ...
  PORTB->CFUNC[0] =  0x0000FFFF; //0-7
  PORTB->SFUNC[0] =  0x00000000;
  PORTB->CFUNC[1] =  0xFFFFFFF0; //6-15
  PORTB->SFUNC[1] =  0x50000000;         // UART0
  PORTB->CFUNC[2] =  0xFF00000F; //16-23
  PORTB->SFUNC[2] =  0x99000005;        //PWM
  PORTB->CFUNC[3] =  0x00000000; //24-31
  PORTB->SFUNC[3] =  0x00000000;
  PORTB->SPWR[0] =   0x80000000;
  PORTB->SPWR[1] =   0x0000F002;
  PORTB->SPULLDOWN = 0x00000000;
  PORTB->SPULLUP   = 0x0001860F;
  PORTB->SPD       = 0x00C00000;
  ...
  PORTE->SFUNC[1] =  0x00000000;
  PORTE->CFUNC[2] =  0xFFFFFFFF;
  PORTE->SFUNC[2] =  0x00000000;
  PORTE->SOE      =  0x00FFFFC0;
  PORTE->SPWR[0]  =  0x55555FFF;
  PORTE->SPWR[1]  =  0x0000555D;
